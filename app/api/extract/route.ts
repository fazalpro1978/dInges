...
- view: Extract from any "VIEW", "View", "Orientation", "Facing", "Outlook" column. Normalise to the closest value from this list: Front View | Side View | Back View | Corner View | Full View | Pool View | Swimming Pool View | Sea View | City View | Garden View | Street View | Marina View | Park View | Mountain View | Panoramic View | Partial View | Internal View | Open View | Porto Arabia View. If the source value doesn't match any of these options closely, omit the field. Do not invent values outside this list.
